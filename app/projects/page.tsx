        ...
        <div className="relative overflow-hidden pt-32 md:pt-40">
            ...
            <section className="relative shell pb-10">
                <SectionHeading
                    ...
                    subtitle="Four builds that cover the range — an AI code-repair pipeline, a multi-agent research assistant, a secured multi-tenant agent, and an end-to-end ML pipeline."
                />
